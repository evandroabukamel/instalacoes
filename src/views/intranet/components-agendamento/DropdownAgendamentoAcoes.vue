<template>
  <b-dropdown class="is-pulled-right is-right">
    ...
    <b-dropdown-item
      v-if="showConfirmarAgendamento"
      @click="emit('confirmarAgendamento')"
    >
      Confirmar agendamento
    </b-dropdown-item>
    <b-dropdown-item
      v-if="showCancelarAgendamento"
      @click="emit('cancelarAgendamento')"
    >
      Cancelar agendamento
    </b-dropdown-item>
    <b-dropdown-item
      v-if="showIniciarServico"
      @click="emit('iniciarOrdemServico')"
    >
      Iniciar ordem de serviço
    </b-dropdown-item>
    <b-dropdown-item
      v-if="showFinalizarServico"
      @click="emit('finalizarOrdemServico')"
    >
    ...
    <b-dropdown-item
      v-if="showCancelarServico"
      @click="emit('cancelarOrdemServico')"
    >
...
export default {
  ...
  computed: {
    ...mapGetters(['dadosUsuario', 'situacaoAgendamento']),
    ...
    showIniciarServico() {
      return (
        _.includes([this.situacaoAgendamento.AGENDADO], this.situacaoAtual) &&
        (_.includes(this.dadosUsuario.roles, 'ROLE_TECNICO') ||
          _.includes(this.dadosUsuario.roles, 'ROLE_EMPRESA') ||
          _.includes(this.dadosUsuario.roles, 'ROLE_MATRIZFILIAL'))
      );
    ...
    showFinalizarServico() {
      return (
        _.includes(
          [this.situacaoAgendamento.EM_ATENDIMENTO],
          this.situacaoAtual
        ) &&
        (_.includes(this.dadosUsuario.roles, 'ROLE_TECNICO') ||
          _.includes(this.dadosUsuario.roles, 'ROLE_EMPRESA') ||
