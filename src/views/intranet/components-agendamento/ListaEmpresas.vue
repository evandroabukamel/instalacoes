<template>
  <div>
    <nav class="panel">
      <p class="panel-heading">Empresas encontradas</p>
        ...
        >
          ...
          <expanding>
            <div class="panel-block" v-show="activeIndex == index">
              <div class="content">
                Endereço
                <b-field :label="item.empresa.endereco | enderecoStr"></b-field>
                Valor
                <b-field :label="item.valorVenda | formatMoney"></b-field> Tempo
                previsto
                <b-field :label="item.tempoPrevisto | horaMinuto"></b-field>
                <button
