        ...
        >
          <div class="columns">
            <div class="column is-half-desktop">
              <h2 class="subtitle">
                <span v-html="'Dados da matriz/filial'"></span>
              </h2>
              <input-text
                name="nomeFantasia"
                ...
                :error="form.errors.get('nomeFantasia')"
              ></input-text>
              <input-text
                name="razaoSocial"
                ...
                :error="form.errors.get('razaoSocial')"
              ></input-text>
              <input-text
                name="cnpj"
                v-model="form.cnpj"
              ...
              <input-text
                ...
                :error="form.errors.get('inscricaoMunicipal')"
              ></input-text>
              <input-text
                name="email"
                v-model="form.email"
              ...
              <input-text
                ...
                :error="form.errors.get('responsavel')"
              ></input-text>
            </div>
            <div class="column is-half-desktop">
              <!-- Contatos -->
