  ...
  <div class="columns is-centered">
    <div class="column">
      <h1
        ...
        v-html="'Cadastro de feriados e folgas'"
      ></h1>
          ...
          <div class="columns">
            <div class="column is-full">
              <b-message :closable="false" type="is-info" has-icon>
                Use essa tela para cadastrar os dias que você não poderá
                atender.
              </b-message>
              <date-time-picker
                placeholder="Data inicial e final"
                name="dataInicial"
        ...
        >
          <template slot-scope="props">
            ...
            <b-table-column label="Ações" numeric>
              ...
              <p v-else>
                <b-icon icon="minus" type="is-dark" size="is-medium"></b-icon>
              </p>
            </b-table-column>
          </template>
          <template slot="empty">
...
export default {
  ...
  computed: {
    ...
    dataConfig() {
      ...
      const onChange = (selectedDates, dateStr, instance) => {
        const dateArr = selectedDates.map((date) =>
  ...
  methods: {
    ...
    getList() {
      ...
      this.axios
        .get(
          `/feriado/getList/page=${this.page}&perPage=${this.perPage}` +
