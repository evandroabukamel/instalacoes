      ...
      <div>
        <div class="tabs is-boxed">
          <ul>
            ...
            <li :class="{ 'is-active': activeTab == 5 }" v-if="form.id > 0">
              <a @click="activeTab = 5">
            ...
            <div class="columns">
              <div class="column is-half-desktop">
                <select-ajax
                  ...
                  ref="selectTipoConsultoria"
                  v-model="form.tipoConsultoria.id"
                  size="is-medium"
                  ...
                  v-on:errorSelectAjax="
                    form.setSelectError('tipoConsultoria', $event)
                  "
                >
                  <option
                    v-if="!isSituacaoAberto && form.tipoConsultoria.id"
                ...
                <date-time-picker
                  placeholder="Data da entrega do documento"
                  v-if="!(isSituacaoCancelado || isSituacaoConcluido)"
                ...
                <b-field v-else label="Data da entrega do documento">
                  <span class="subtitle">{{
                    form.dataEntregaDocumento | date
                  }}</span>
                </b-field>
              </div>
            </div>
...
export default {
  ...
  components: {
    ...
    InputCusto,
    ListaCusto,
    DropdownConsultoriaAcoes,
    InputConsultoriaHorario,
    ListaConsultoriaHorario,
  },
  data() {
    return {
      form: new Form({
  ...
  computed: {
    ...mapGetters(['dadosUsuario', 'situacaoConsultoria']),
    ...
    isSituacaoAberto() {
      return (
        this.situacaoConsultoria.ABERTO == this.form.situacao.id ||
    ...
    onIniciarConsultoria() {
      this.$dialog.confirm({
        ...
        onConfirm: () => {
          ...
          this.axios
            .post('/consultoria/iniciarConsultoria', {
              id: this.form.id,
            })
            .then((response) => {
              ...
              if (response.data) {
                this.$toast.open({
                  message: response.data.message
                    ...
                    : 'Consultoria iniciada com sucesso.',
                  type: 'is-success',
                  position: 'is-top',
                  duration: 5000,
                });
    ...
    onFinalizarConsultoria() {
      this.$dialog.confirm({
        ...
        onConfirm: () => {
          this.form.isLoading = true;
          this.axios
            .post('/consultoria/finalizarConsultoria', {
              id: this.form.id,
            })
            .then((response) => {
              this.form.isLoading = false;
              if (response.data) {
                this.$toast.open({
                  message: response.data.message
                    ? response.data.message
                    : 'Consultoria finalizada com sucesso.',
                  type: 'is-success',
                  position: 'is-top',
                  duration: 5000,
                });
            ...
            .then((response) => {
              ...
              if (response.data) {
                this.$toast.open({
                  message: response.data.message
                    ? response.data.message
                    : 'Consultoria concluída com sucesso.',
                  type: 'is-success',
                  position: 'is-top',
                  duration: 5000,
                });
            ...
            .then((response) => {
              ...
              if (response.data) {
                this.$toast.open({
                  message: response.data.message
                    ? response.data.message
                    : 'Consultoria cancelada com sucesso.',
                  type: 'is-success',
                  position: 'is-top',
                  duration: 5000,
                });
