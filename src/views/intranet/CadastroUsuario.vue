<template>
  <div class="columns is-centered">
    <div class="column">
      <h1
        class="title is-clearfix"
        v-html="
          $route.path == '/meu-usuario'
            ? 'Meu usu&aacute;rio'
        ...
        >
          <div class="columns">
            <div class="column is-half-desktop">
              <h2 class="subtitle">
                <span v-html="'Dados do usu&aacute;rio'"></span>
              </h2>
              <input-autocomplete
                v-if="
                  showAutocompleteMatrizFilial &&
                  $route.name == 'cadastro-usuario'
                "
                ...
                :error="form.errors.get('matrizFilial')"
              ></input-autocomplete>
              <input-text
                type="text"
                name="nome"
              ...
              <b-field v-if="!form.id">
                <input-text
                  ...
                  :has-error="form.errors.has('senha')"
                ></input-text>
              </b-field>
              <input-text
                type="email"
            ...
            <div class="column is-half-desktop">
                ...
                >
                  <template slot-scope="props">
                    <b-table-column
                      ...
                      :custom-key="props.row[index].value"
                      centered
                    >
                      <b-field
                      ...
                      >
                        <b-checkbox
                          type="is-primary"
                          name="diasAcesso[]"
                          v-model="form.diasAcesso[props.row[index].value]"
                        ></b-checkbox>
                      </b-field>
                      <span v-else class="icon">
                        <b-icon
                          icon="checkbox-marked-outline"
                          v-if="form.diasAcesso[props.row[index].value]"
                        ></b-icon>
              ...
              <div class="field">
                <h2 class="subtitle">
                  <span v-html="'Hor&aacute;rios de acesso'"></span>
                </h2>
                <b-field grouped>
                  <date-time-picker
                ...
                <span
                  ...
                  v-if="form.errors.has('horario')"
                  v-text="form.errors.get('horario')"
                ></span>
              </div>
    ...
    setMatrizFilial(obj) {
      ...
      if (obj && parseInt(obj.id) > 0 && this.form.classe == 'tbmatrizfilial') {
        ...
        if (
          ...
          this.$route.name == 'cadastro-usuario'
        ) {
