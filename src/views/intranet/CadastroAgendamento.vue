    ...
    <div class="column">
      ...
      <h1 class="title is-clearfix">
        <div class="columns">
          ...
          <div
            class="column is-half is-right"
            v-if="form.id > 0 && form.situacao.id > 0"
          >
        ...
        >
          ...
          <div v-show="activeTab == 1">
            <div class="columns">
              <div class="column is-half-desktop">
                ...
                <input-text
                  ...
                  :maxlength="128"
                  :disabled="
                    !(isSituacaoAberto || isSituacaoRemarcado) ||
                    !(isUsuarioMatrizFilial || isUsuarioCliente)
                  "
                  :has-error="form.errors.has('beneficiario')"
                  :error="form.errors.get('beneficiario')"
                ></input-text>
              ...
              <div class="column is-half-desktop">
                <input-text
                  ...
                  :error="form.errors.get('placaVeiculo')"
                ></input-text>
                <input-autocomplete
                  name="marcaVeiculo"
                  ...
                  :init-value="
                    form.marcaVeiculo ? form.marcaVeiculo.descricao : null
                  "
                  field="descricao"
                  :minlength="2"
                ...
                <input-autocomplete
                  ...
                  :init-value="
                    form.modeloVeiculo ? form.modeloVeiculo.descricao : null
                  "
                  field="descricao"
                  :minlength="2"
                ...
                <select-ajax
                  name="corVeiculo"
                  ref="selectCorVeiculo"
                  v-model="form.corVeiculo.id"
                  size="is-medium"
                  ...
                  v-on:errorSelectAjax="
                    form.setSelectError('corVeiculo', $event)
                  "
                >
                  <option
                    v-if="
            ...
            >
              ...
              <div
                ...
                v-if="isSituacaoAberto || isSituacaoRemarcado"
              >
                <!-- Mapa -->
                <here-maps
                  ref="clienteMap"
                  :value="markersSolicitante"
                  v-if="
                    (isSituacaoAberto || isSituacaoRemarcado) && activeTab == 1
                  "
              ...
              <div class="column is-half-desktop">
                ...
                <b-field>
                  <b-message
                    ...
                    v-show="
                      (isSituacaoAberto || isSituacaoRemarcado) &&
                      (isUsuarioCliente || isUsuarioMatrizFilial)
                    "
                  >
                    Esta data e horário estão sujeitos a análise e poderão ser
                    alterados conforme a disponibilidade.
                  </b-message>
                </b-field>
                <date-time-picker
                ...
                <b-field
                  ...
                  v-if="
                    ((isSituacaoAberto || isSituacaoRemarcado) &&
                      !(isUsuarioCliente || isUsuarioMatrizFilial)) ||
                    (isSituacaoCancelado &&
                      this.form.dataPreferida &&
                      this.form.horaPreferida)
                  "
                >
                  <span class="subtitle"
                    >{{ this.form.dataPreferida | date }} às
                    {{ this.form.horaPreferida | time }}</span
                  >
                </b-field>
                <b-field
                ...
                >
                  <span class="subtitle"
                    >{{ this.form.dataAgendamento | date }} às
                    {{ this.form.horaAgendamento | time }}</span
                  >
                </b-field>
              </div>
              <div class="column is-half-desktop">
                ...
                <b-field v-show="form.enviarEquipamento">
                  <select-ajax
                    ...
                    ref="selectMarcaEquipamento"
                    v-model="form.marcaEquipamento.id"
                    size="is-medium"
                    ...
                    @errorSelectAjax="
                      form.setSelectError('marcaEquipamento', $event)
                    "
                  >
                    <option
                      v-if="
                ...
                <b-field v-show="form.enviarEquipamento">
                  <select-ajax
                    ...
                    ref="selectModeloEquipamento"
                    v-model="form.modeloEquipamento.id"
                    size="is-medium"
                    ...
                    @errorSelectAjax="
                      form.setSelectError('modeloEquipamento', $event)
                    "
                  >
                    <option
                      v-if="
                ...
                <input-text
                  ...
                  v-model="form.codigoRastreamentoEnvio"
                  size="is-medium"
                  :disabled="
                    isSituacaoConcluido ||
                    isSituacaoCancelado ||
                  ...
                  :error="form.errors.get('codigoRastreamentoEnvio')"
                ></input-text>
                      ...
                      <b-field grouped position="is-right">
                        <b-field>
                          ...
                          >
                            ...
                            <span
                              v-html="'Buscar empresas pr&oacute;ximas'"
                            ></span>
                          </button>
                        </b-field>
                      </b-field>
                    ...
                    <div class="media">
                      <div class="media-content">
                        ...
                        <p class="subtitle is-8">
                          Endereço:
                          {{
                            (form.tecnico.atendeFora
                              ? form.tecnico.endereco
                              : form.valorServico.empresa.endereco)
                              | enderecoStr
                          }}
                        </p>
                        <p
                          class="subtitle is-8"
                          v-if="isUsuarioCliente || isUsuarioMatrizFilial"
                        >
                          Técnico: {{ form.tecnico.nome }}
                        </p>
                        <p class="subtitle is-8">
                          Tempo previsto:
                          {{ form.valorServico.tempoPrevisto | horaMinuto }}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="field" v-if="!form.tecnico && !isSituacaoCancelado">
                  ...
                  >
                    <modal-tecnicos
                      ...
                      @selected="selectTecnico"
                    ></modal-tecnicos>
                  </b-modal>
                </div>
                <div class="field" v-if="form.valorServico && form.tecnico">
                  <lista-contato
                    v-bind:value="form.valorServico.empresa.contatos"
            ...
            <div class="columns">
              <div class="column is-half-desktop">
                <input-text
                  ...
                  :error="form.errors.get('localInstalacao')"
                ></input-text>
                <input-autocomplete
                  name="equipamento"
                  ...
                  :init-value="
                    form.equipamento ? form.equipamento.numero : null
                  "
                  field="numero"
                  subtitle="imei"
                  field-label="Número"
                  ...
                  :error="form.errors.get('equipamento')"
                ></input-autocomplete>
                <input-autocomplete
                  name="chip"
                ...
                <input-autocomplete
                  ...
                  :init-value="
                    form.equipamentoRemovido
                      ? form.equipamentoRemovido.numero
                      : null
                  "
                  field="numero"
                  subtitle="imei"
                  ...
                  :error="form.errors.get('equipamentoRemovido')"
                ></input-autocomplete>
                <input-autocomplete
                  v-show="form.devolverItens"
                  name="chipRemovido"
                  ...
                  :init-value="
                    form.chipRemovido ? form.chipRemovido.telefone : null
                  "
                  field="telefone"
                  subtitle="imei"
                  field-label="Telefone"
                  ...
                  :error="form.errors.get('chipRemovido')"
                ></input-autocomplete>
                <input-text
                  v-show="form.devolverItens"
                  name="codigoRastreamentoDevolucao"
                  v-model="form.codigoRastreamentoDevolucao"
                  size="is-medium"
                  :disabled="
                    isSituacaoConcluido ||
                    isSituacaoCancelado ||
                  ...
                  :error="form.errors.get('codigoRastreamentoDevolucao')"
                ></input-text>
                <b-field label="Os testes foram realizados?" expanded>
                  <b-field position="is-left">
                    <b-radio-button
                      v-model="form.testeRealizado"
                      :native-value="false"
                      :disabled="
                        isSituacaoConcluido ||
                        isSituacaoCancelado ||
                ...
                <input-text
                  name="motivoNaoTestado"
                  type="textarea"
                  maxlength="254"
                  v-show="!form.testeRealizado"
                  :has-counter="true"
                  v-model="form.motivoNaoTestado"
                  size="is-medium"
                  :disabled="isUsuarioCliente"
                  placeholder="Motivo de não realização dos testes"
                  :has-error="form.errors.has('motivoNaoTestado')"
                  :error="form.errors.get('motivoNaoTestado')"
                ></input-text>
              </div>
              <div class="column is-half-desktop">
                <b-field
                ...
                >
                  ...
                  <b-modal
                    ref="modalFotoEndereco"
                    :active.sync="modalFotoEnderecoActive"
                  >
                    <modal-foto-endereco
                      :endereco.sync="enderecoFotoTemp"
                    ></modal-foto-endereco>
                  </b-modal>
                </b-field>
                <!-- FOTO UPLOAD -->
                    ...
                    >
                      ...
                      >
                        <a
                          ...
                          @click.prevent="excluirFoto(foto.id)"
                          title="Apagar"
                        >
                        ...
                        <a
                          ...
                          @click.prevent="showModalFotoEndereco(foto.endereco)"
                          title="Localização"
                        >
          ...
          <div v-show="activeTab == 5">
            <div class="columns">
              <div class="column is-half-desktop">
                ...
                <lista-custo v-model="custos" :show-remove-button="false">
                </lista-custo>
              </div>
              <div class="column is-half-desktop">
                ...
                <input-custo
                  ...
                  :error="form.errors.get('custoAdicional')"
                ></input-custo>
                <lista-custo
                  v-model="form.custosAdicionais"
                  :show-remove-button="
                    isUsuarioMatrizFilial &&
                    !(isSituacaoConcluido || isSituacaoCancelado)
                  "
          ...
          <div v-show="activeTab == 6">
            ...
            >
              <div class="column is-fullwidth">
                ...
                <input-text
                  ...
                  :error="form.errors.get('novaObservacao')"
                ></input-text>
                <b-field grouped position="is-right">
                  <button
                    type="button"
            ...
            <div class="columns">
              <div class="column is-fullwidth">
                <b-field
                  v-for="(obs, indexObs) in observacoes"
                  :key="indexObs"
                  class="observacao-message"
                  grouped
                  :position="
                    isCurrentUser(obs.usuarioId) ? 'is-right' : 'is-left'
                  "
                >
                  <article
                    :class="[
                      'message',
                      'control',
                      getMessageColor(obs.usuarioClasse),
                    ]"
                  >
                    <div class="message-header">
                      <p>
                        {{
                          `${
                            obs.usuarioNome
                          } escreveu ${$options.filters.timeAgo(
                            obs.dataHoraCadastro
                          )}:`
                        }}
                      </p>
                      <p v-html="'&nbsp;'"></p>
...
export default {
  ...
  computed: {
    ...
    modeloEquipamento() {
      return this.form.modeloEquipamento
        ? this.form.modeloEquipamento.id
        : null;
    },
    ...
    isSituacaoAberto() {
      return (
        this.situacaoAgendamento.ABERTO == this.form.situacao.id ||
        this.form.situacao.id == null
      );
    },

    isSituacaoAguardandoAgendamento() {
      return (
        this.situacaoAgendamento.AGUARDANDO_CONFIRMACAO == this.form.situacao.id
      );
    },
    ...
    urlAutocompleteModeloVeiculo() {
      return `/marcaModeloVeiculo/findLikeModelo/${
        (this.form.marcaVeiculo ? this.form.marcaVeiculo.id : '0') || ''
      }`;
    },
    ...
    urlAutocompleteEquipamento() {
      return `/estoque/findLike/equipamento/${
        this.modeloEquipamento || 0
      }/disponivel`;
    },
  ...
  methods: {
    ...mapActions(['salvarObservacao', 'excluirObservacao']),
          ...
          .catch((error) => {
            this.$toast.open({
              message: error.message
                ? error.message
                : 'Erro ao buscar empresas próximas.',
              type: 'is-warning',
              position: 'is-top',
              duration: 5000,
            });
    ...
    addEmpresaMarker(valorServico, count) {
      ...
      let marker = {
        ...
        draggable: false,
        icon: this.$refs.empresasMap.getMarkerIcon(
          `classificacao${classificacao}/number_${count}`
        ),
      };
    ...
    dataPreferidaDisableByParametros() {
      if (!this.isUsuarioMatrizFilial) {
        ...
        if (this.form.enviarChip || this.form.enviarEquipamento) {
          let diasAntecedencia = this.parametros
            .diasAntecedenciaAgendamentoComEnvio;
          ...
          let diasAntecedencia = this.parametros
            .diasAntecedenciaAgendamentoSemEnvio;
        ...
        this.$set(
          this.dataPreferidaDatepickerDisabled,
          'to',
    ...
    getMessageColor(usuarioClasse) {
      return usuarioClasse == 'tbmatrizfilial'
        ? 'is-dark'
        : usuarioClasse == 'tbcliente'
        ? 'is-blue'
        : usuarioClasse == 'tbempresa'
        ? 'is-green'
        : usuarioClasse == 'tbtecnico'
        ? 'is-turquoise'
        : 'is-light';
    },
    ...
    updateCustoServico(val) {
      let i = _.findIndex(this.custos, function (c) {
        return c.tipo == 'servico';
      });
      if (i >= 0) {
    ...
    getValorMedioServico(idTipoServico) {
      if (idTipoServico > 0 && this.isSituacaoAberto) {
        this.axios
          .get(`/agendamento/obterMediaValorServico/${idTipoServico}`)
          .then((response) => {
            ...
            if (error.response.data) {
              this.$toast.open({
                message: error.response.data.message
                  ...
                  : 'Erro ao obter valor médio do servico.',
                type: 'is-warning',
                position: 'is-top',
                duration: 5000,
              });
    ...
    getEstoqueValorVenda(classe, idSubtipo) {
      return new Promise((resolve, reject) => {
        this.axios
          .get(`/agendamento/obterEstoqueValorVenda/${classe}/${idSubtipo}`)
          .then((response) => {
          ...
          .catch((error) => {
            if (error.response.data) {
              this.$toast.open({
                message: error.response.data.message
                  ? error.response.data.message
                  : 'Erro ao procurar por item no estoque.',
                type: 'is-warning',
                position: 'is-top',
                duration: 5000,
              });
    ...
    setEquipamento(obj) {
      if (obj && obj.id > 0) {
        ...
        let custo = {
          id: obj.id,
          descricao:
            'Equipamento: ' + `${obj.marcaEquipamento.descricao || ''}`,
          valor: obj.valorVenda,
          tipo: 'equipamento',
        };
        let i = _.findIndex(this.custos, function (c) {
          return c.tipo == 'equipamento';
        });
        if (i >= 0) {
          this.custos.splice(i, 1);
          this.custos[i] = custo;
        ...
        onConfirm: () => {
          ...
          this.axios
            ...
            .then((response) => {
              ...
              let i = _.findIndex(vm.fotos, function (c) {
                return c.id == response.data.idFoto;
              });
              if (i >= 0) {
                vm.fotos.splice(i, 1);
              }
    ...
    onCancelarAgendamento() {
      this.$dialog.prompt({
        ...
        onConfirm: (value) => {
          this.form.isLoading = true;
          this.axios
            .post('/agendamento/cancelarAgendamento', {
              id: this.form.id,
    ...
    onIniciarOrdemServico() {
      this.$dialog.confirm({
        ...
        onConfirm: () => {
          this.form.isLoading = true;
          this.axios
            .post('/agendamento/iniciarOrdemServico', {
              id: this.form.id,
            })
            .then((response) => {
              this.form.isLoading = false;
            ...
            .catch((error) => {
              ...
              if (error.response && error.response.data) {
                this.$toast.open({
                  message: error.response.data.message
                    ? error.response.data.message
                    : 'Erro ao iniciar ordem de serviço.',
                  type: 'is-warning',
                  position: 'is-top',
                  duration: 5000,
                });
    ...
    onFinalizarOrdemServico() {
      this.$dialog.confirm({
        ...
        onConfirm: () => {
          this.form.isLoading = true;
          this.axios
            .post('/agendamento/finalizarOrdemServico', {
              id: this.form.id,
            })
            .then((response) => {
              this.form.isLoading = false;
            ...
            .catch((error) => {
              ...
              if (error.response && error.response.data) {
                this.$toast.open({
                  message: error.response.data.message
                    ? error.response.data.message
                    : 'Erro ao cancelar ordem de serviço.',
                  type: 'is-warning',
                  position: 'is-top',
                  duration: 5000,
                });
      ...
      this.$dialog.confirm({
        ...
        onConfirm: () => {
          ...
          this.excluirObservacao({
            ...
            .then((data) => {
              this.form.isLoading = false;
              let i = _.findIndex(this.observacoes, function (o) {
                return o.id == idObservacao;
              });
              if (i >= 0) {
    ...
    setFormData(response, error) {
      if (error) {
          ...
          if (
            ...
            _.includes(
              [
                ...
                this.situacaoAgendamento.REMARCADO,
              ],
        ...
        if (!response.data.horaAgendamento) {
          this.form.horaPreferida = moment(response.data.horaPreferida).format(
            'HH:mm:ss'
          );
        }
  ...
  watch: {
    ...
    activeTab: function (tab) {
      if (tab == 3) {
        if (
          Boolean(this.form.endereco.posicao) &&
          this.markersEmpresas.length == 0
        ) {
      ...
      .catch((error) => {
        if (error.response && error.response.data) {
          this.$toast.open({
            message: error.response.data.message
              ? error.response.data.message
              : 'Erro ao carregar os parâmtros do sistema.',
            type: 'is-danger',
            position: 'is-top',
            duration: 5000,
          });
