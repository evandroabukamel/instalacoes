      ...
      >
        <template slot-scope="props">
          ...
          <b-table-column
            ...
            label="Cliente"
            sortable
            :visible="Boolean(props.row.cliente)"
          >
            {{ props.row.cliente || '' }}
          </b-table-column>
          <b-table-column
            ...
            label="Técnico"
            sortable
            :visible="Boolean(props.row.tecnico)"
          >
            {{ props.row.tecnico || '' }}
          </b-table-column>
          <b-table-column label="Tipo">
            <b-tag v-if="props.row.cliente" type="is-success"> Receita </b-tag>
            <b-tag v-else type="is-danger"> Pagamento </b-tag>
          </b-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.axios
        .get(
          `/lancamento/getList/tipo=${this.tipo}&page=${this.page}&perPage=${this.perPage}` +
