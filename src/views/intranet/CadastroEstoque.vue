    ...
    <div class="column">
      ...
      <b-message :closable="false">
        ...
        >
          ...
          <div
            class="columns"
            v-show="Boolean(form.classe) && !Boolean(form.cliente)"
          >
            <div class="column is-half-desktop">
              <input-text
                name="valorCusto"
...
export default {
  ...
  computed: {
    ...mapGetters(['dadosUsuario', 'isUsuarioMatrizFilial']),
  ...
  methods: {
    ...
    setFormData(response, error) {
      if (error) {
        ...
        if (this.form.operadora == null)
          this.form.operadora = { id: null, descricao: null };
        if (this.form.marcaEquipamento == null)
          this.form.marcaEquipamento = { id: null, descricao: null };
        if (this.form.modeloEquipamento == null)
          this.form.modeloEquipamento = { id: null, descricao: null };
      }
    },
  },
