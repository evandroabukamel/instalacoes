    ...
    <div :class="outterClass">
      <div :class="columnClass">
        ...
        <input-text
          ...
          :size="size"
          :error="error.usuario"
          :has-error="Boolean(error.usuario)"
        ></input-text>
        ...
        <input-text
          ...
          :has-error="Boolean(error.telefone)"
        ></input-text>
      ...
      <div :class="columnClass">
              ...
              >
                <b-field position="is-centered">
                  <b-checkbox
                    type="is-primary"
                    name="diasAcesso[]"
                    v-model="usuario.diasAcesso[props.row[index].value]"
                  ></b-checkbox>
                </b-field>
              </b-table-column>
            </template>
        ...
        <b-field grouped>
          ...
          <span
            ...
            v-if="Boolean(error.horario)"
            v-text="error.horario"
          ></span>
        </b-field>
