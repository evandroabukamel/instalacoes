...
const checkRoleCliente = function () {
  return (
    _.includes(store.getters.dadosUsuario.roles, 'ROLE_CLIENTE') ||
...
const checkRoleEmpresa = function () {
  return (
    _.includes(store.getters.dadosUsuario.roles, 'ROLE_EMPRESA') ||
    _.includes(store.getters.dadosUsuario.roles, 'ROLE_ADMIN')
  );
};
...
const checkRoleMatrizFilial = function () {
  return (
    _.includes(store.getters.dadosUsuario.roles, 'ROLE_MATRIZFILIAL') ||
    _.includes(store.getters.dadosUsuario.roles, 'ROLE_ADMIN')
  );
};
...
const checkRoleTecnico = function () {
  return (
    _.includes(store.getters.dadosUsuario.roles, 'ROLE_TECNICO') ||
    _.includes(store.getters.dadosUsuario.roles, 'ROLE_ADMIN')
  );
};
  ...
  categories: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          meta: {
            id: () => {
              return store.getters.dadosUsuario.idObjeto;
            },
            showTo: ['ROLE_CLIENTE'],
          },
        ...
        },
        {
          ...
          meta: {
            id: () => {
              return store.getters.dadosUsuario.id;
            },
          },
          beforeEnter: redirectLogged,
        },
