<template>
	<div class="columns is-centered">
		<div class="column is-12-mobile is-8-tablet is-5-desktop">
			<h1 class="title is-clearfix has-text-centered">Cadastre-se como cliente</h1>
				...
				<form name="cadastrarClienteForm" method="post" action="#"
					...
					<div v-show="etapa == 1">
						...
						<select-ajax name="idTipoPagamento" v-model="form.idTipoPagamento"
							placeholder="Tipo de pagamento" size="is-medium"
					...
					<div class="columns is-flex-mobile">
						...
						<div class="column is-half field has-addons has-addons-right" v-show="etapa < 3">
							<div class="control">
						...
						<div class="column is-half field has-addons has-addons-right" v-if="etapa == 3">
							<div class="control">
								<button type="button" class="button is-primary is-medium"
...
export default {
	...
	methods: {
		...
		onSubmit() {
			this.clearMessages();
            this.form.post('/cliente/cadastrar')
			.then(response => {
