<template>
	<div class="columns is-centered">
		<div class="column is-12-mobile is-8-tablet is-5-desktop">
			<h1 class="title is-clearfix has-text-centered">Cadastre-se como empresa especializada</h1>
			<b-message v-show="!successMessage" type="is-primary" :closable="false">
				<form name="cadastrarClienteForm" method="post" action="#"
					...
					<div v-show="etapa == 1">
						<!-- Dados do cliente -->
						<h2 class="subtitle"><span v-html="'Informa&ccedil;&otilde;es cadastrais'"></span></h2>
					...
					<div v-show="etapa == 2">
						...
						<div class="content"><!-- SPACE --></div>
						<!-- Mapa -->
						<here-maps v-if="etapa == 2" ref="hereMap" v-model="markers"
					...
					<div v-show="etapa == 3">
						...
						<select-ajax name="idBanco" v-model="form.idBanco"
							placeholder="Banco" 
							control-type="is-primary" size="is-medium"
					...
					<div class="columns is-flex-mobile">
						<div class="column is-half">
							<div class="control">
								<button type="button" class="button is-primary is-medium" v-show="etapa > 1"
									@click="etapa--" @dblclick.prevent>
									Voltar
								</button>
							</div>
						</div>
						<div class="column is-half field has-addons has-addons-right" v-show="etapa < 4">
							<div class="control">
						...
						<div class="column is-half field has-addons has-addons-right" v-if="etapa == 4">
							<div class="control">
								<button type="button" class="button is-primary is-medium"
				...
				<b-field v-if="Boolean(errorMessage)">
					<b-message type="is-danger" :active="Boolean(errorMessage)"
						:closable="false" :has-icon="false">
						{{ errorMessage }}
					</b-message>
				</b-field>
			</b-message>
			<b-field v-if="Boolean(successMessage)">
				<b-message type="is-success" :active="Boolean(successMessage)"
					:closable="false" :has-icon="false">
					{{ successMessage }}
				</b-message>
			</b-field>
...
export default {
	...
	methods: {
		...
		onSubmit() {
			this.clearMessages();
            this.form.post('/empresa/cadastrar')
			.then(response => {
