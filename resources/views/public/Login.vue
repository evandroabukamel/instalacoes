<template>
	<div class="columns is-centered">
		<div class="column is-half-tablet is-one-third-desktop">
			<b-message title="Acesso ao sistema" type="is-primary" size="is-medium" :closable="false">
				<form name="loginForm" method="post" action="#"
					...
					<input-text type="password" v-model="form.senha"
						name="password"
						placeholder="Senha"
						size="is-medium"
					...
					<div class="field">
						<div class="control level">
							...
							<div class="level-right">
								<router-link to="/esqueci-minha-senha" tag="button" 
