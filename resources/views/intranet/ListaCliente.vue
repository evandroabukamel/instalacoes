<template>
	<div>
		<h1 class="title is-clearfix">Lista de clientes</h1>
		<div class="is-clearfix">
			...
			<b-table
				...
				<template slot-scope="props">
					<b-table-column field="c.nome" label="Nome" sortable>
						{{ props.row.nome }}
					</b-table-column>
					<b-table-column field="c.cpfcnpj" label="CPF/CNPJ" sortable>
					...
					<b-table-column label="Ações" numeric>
						<router-link :to="{ name: 'cadastro-cliente', params: {id: props.row.id} }"
...
export default {
	...
	methods: {
		...
		getList() {
			this.loading = true;
			this.axios.get(`/cliente/getList/page=${this.page}&perPage=${this.perPage}&text=${this.text}`
