	...
	<div>
		...
		<div class="is-clearfix">
			...
			<b-table
				...
				:row-class="(row, index) => dateIsToday(row.dataAgendamento) 
					? 'agendamento-hoje'
				...
				<template slot-scope="props">
					...
					<b-table-column field="a.dataAgendamento" label="Data/Hora Agendamento" sortable>
					...
					<b-table-column label="Ações" numeric>
						<router-link :to="{ name: 'cadastro-agendamento', params: {id: props.row.id} }"
...
export default {
	...
	methods: {
		...
		getList() {
			this.loading = true;
			this.axios.get(`/agendamento/getList/page=${this.page}&perPage=${this.perPage}&text=${this.text}`
