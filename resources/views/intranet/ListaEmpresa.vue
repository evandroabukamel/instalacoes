		...
		<div class="is-clearfix">
			...
			<b-table
				...
				<template slot-scope="props">
					...
					<b-table-column field="e.classificacao" label="Classificação" centered sortable>
						<span class="tag is-medium" :class="rating(props.row.classificacao)">
					...
					<b-table-column label="Ações" numeric>
						<router-link :to="{ name: 'cadastro-empresa', params: {id: props.row.id} }"
...
export default {
	...
	methods: {
		...
		getList() {
			...
			this.axios.get(`/empresa/getList/page=${this.page}&perPage=${this.perPage}&text=${this.text}`
