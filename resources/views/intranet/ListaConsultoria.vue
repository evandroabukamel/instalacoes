	...
	<div>
		...
		<div class="is-clearfix">
			...
			<b-table
				...
				:row-class="(row, index) => dateIsToday(row.dataInicial) 
					? 'data-inicial-hoje'
					: ''">
				<template slot-scope="props">
					...
					<b-table-column field="c.dataEntregaDocumento" label="Data entrega" sortable>
					...
					<b-table-column label="Ações" numeric>
						<router-link :to="{ name: 'cadastro-consultoria', params: {id: props.row.id} }"
...
export default {
	...
	methods: {
		...
		getList() {
			this.loading = true;
			this.axios.get(`/consultoria/getList/page=${this.page}&perPage=${this.perPage}&text=${this.text}`
