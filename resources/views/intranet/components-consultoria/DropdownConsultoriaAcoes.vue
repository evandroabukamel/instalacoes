...
export default {
	...
	computed: {
		...
		showIniciar() {
			return _.includes([
				this.situacaoConsultoria.ABERTO,
				this.situacaoConsultoria.AGENDADO], this.situacaoAtual)
		},
		showFinalizar() {
			return _.includes([
				this.situacaoConsultoria.EM_ANDAMENTO], this.situacaoAtual)
		},
		showConcluir() {
			return _.includes([
				this.situacaoConsultoria.REALIZADO], this.situacaoAtual)
		},
		showCancelar() {
			return true
		}
