<template>
	<div class="modal-card">
		<section class="modal-card-body">
			<!-- FormEndereco -->
			<form-endereco name="enderecoFoto"
				size="is-medium"
				:readonly="true"
				v-model="newEndereco">
			</form-endereco>
			<!-- Mapa -->
			<here-maps ref="fotoMap" v-if="markers.length > 0"
				:value="markers" :show-buscar-posiicao-button="false">
			</here-maps>
		</section>
	</div>
</template>
...
export default {
	...
	mounted() {
		if (typeof(this.endereco) == 'object' && Object.keys(this.endereco).length > 0) {
