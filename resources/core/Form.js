...
export default class Form {
    ...
    data() {
        ...
        for (let field in this.originalData) {
            if (typeof(this[field]) == 'object') {
                if (this[field] != null && _.includes(['Endereco', 'Usuario'], this[field].constructor.name)) {
    ...
    reset() {
        ...
        for (let field in this.originalData) {
            if (typeof(this[field]) == 'string') {
                this[field] = '';
                if (this.originalData[field] != '') this[field] = this.originalData[field];
            }
            else if (typeof(this[field]) == 'number') {
                this[field] = 0;
                if (this.originalData[field] != 0) this[field] = this.originalData[field];
            }
                ...
                this[field] = false;
                if (this.originalData[field] != false) this[field] = this.originalData[field];
            }
            else {
                this[field] = null;
                if (this.originalData[field] != null) this[field] = this.originalData[field];
            }
        }
    ...
    submit(requestType, url, options = null) {
        ...
        return new Promise((resolve, reject) => {
            ...
            .catch((error) => {
                ...
                if (error.response && !_.includes([401, 500], error.response.status)) {
    ...
    loadContatos(source) {
        ...
        for (let a in source) {
            ...
            contato.tipoText = contato.tipo == 'telefone' ? 'Telefone'
     ...
     */
    loadEndereco(source) {
        let endereco = new Endereco({id: null,
            logradouro: '',
            numero: '',
            complemento: '',
            bairro: '',
